...
public class FeedParser {
	...
	public void parseGlobalProperties(Database db) {
		//System.out.println(feed);
		String title = mFeed.getTitle();
		String imageUrl = getFeedUrl();
		
		db.addFeed(mUrl, title, imageUrl);
		System.out.println("Title: " + title);
		System.out.println("Image: " + imageUrl);
	}
	
	public void parsePodcastList(Database db) {
...
//				"http://feeds.thisamericanlife.org/talpodcast"};
		...
		for (String feedName : feeds) {
			...
			//parser.parseGlobalProperties(null);//.parseGlobalProperties();
			parser.parsePodcastList(null);
			System.out.println("\n");
