...
public class TouchInterceptor extends ListView {
    ...
    public TouchInterceptor(Context context, AttributeSet attrs) {
        ...
        TypedArray ta = context.obtainStyledAttributes(new int[] {android.R.attr.listPreferredItemHeight});
        String dipString = ta.getText(0).toString();
        ta.recycle();
        float dipPx = Float.parseFloat(dipString.substring(0, dipString.length()-3));
        //System.out.println("Interceptor: " + ta.getText(0));
        mItemHeightNormal = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, dipPx, res.getDisplayMetrics());
        mItemHeightHalf = mItemHeightNormal / 2;
        mItemHeightExpanded = mItemHeightNormal * 2;
        //mItemHeightExpanded = res.getDimensionPixelSize(ta.getText(0));
        System.out.println("Height normal: " + mItemHeightNormal);
    ...
    private void startDragging(Bitmap bm, int x, int y) {
        ...
        int backGroundColor = context.getResources().getColor(android.R.color.holo_blue_light);
